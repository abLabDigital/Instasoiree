  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="relative">
        <div className="flex flex-col text-white px-3 pt-4 pb-16 md:h-[100vh] md:w-[40vw] md:px-8 md:pt-10">
          <Link href="/">
            <Image
              src="/images/instasoiree.png"
              width={80}
              height={80}
              alt=""
          ...
          <div className="mt-6 md:h-full md:flex md:flex-col md:justify-center">
            <h2 className="text-3xl font-bold md:text-5xl">Join Instasoirée</h2>
